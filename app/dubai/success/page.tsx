...
function DubaiSuccessContent() {
  ...
  // If session finished loading and user is not logged in, redirect to /?city=dubai
  useEffect(() => {
    if (sessionStatus === "unauthenticated") {
      router.replace("/?city=dubai");
      return;
    }
  ...
  useEffect(() => {
    ...
    if (!monitoringId) {
      setStatus("error");
      setErrorMessage("Missing session. Start again from the Dubai form.");
      return;
    }
    setStatus("loading");
